...
- Solo taggear el CSV. No tocar la base (Supabase) desde el subagente (lo hace el orquestador al final con `scripts/db.mjs`, opcional).
...
Diferencias en modo batch:
  - NO actualizar la base (Supabase / `db.mjs`)
  - NO ejecutar `open`
